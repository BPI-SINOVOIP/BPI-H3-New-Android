...
bt_status_t btif_gattc_test_command_impl(uint16_t command, btgatt_test_params_t* params)
{
    switch(command) {
        ...
        case 0xF0: /* Pairing configuration */
            ...
            {
                bte_appl_cfg_rtl.ble_auth_req = params->u1;
                bte_appl_cfg_rtl.ble_io_cap = params->u2;
                bte_appl_cfg_rtl.ble_init_key = params->u3;
                bte_appl_cfg_rtl.ble_resp_key = params->u4;
                bte_appl_cfg_rtl.ble_max_key_size = params->u5;
            }
            else
            {
                bte_appl_cfg_brcm.ble_auth_req = params->u1;
                bte_appl_cfg_brcm.ble_io_cap = params->u2;
                bte_appl_cfg_brcm.ble_init_key = params->u3;
                bte_appl_cfg_brcm.ble_resp_key = params->u4;
                bte_appl_cfg_brcm.ble_max_key_size = params->u5;
            }
            break;
