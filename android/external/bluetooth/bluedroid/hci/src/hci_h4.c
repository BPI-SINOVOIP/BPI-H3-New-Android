...
volatile int brcm_num_hci_cmd_pkts = 1;
        ...
        while (p_msg->len > acl_pkt_size)
        {
            ...
            *p = type;
            ...
            if (hci_used_usb == 0)
                ...
                bytes_sent = usb_write(event,(uint8_t *) p,bytes_to_send);
