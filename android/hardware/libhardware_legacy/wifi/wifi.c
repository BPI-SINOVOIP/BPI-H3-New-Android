...
int wifi_load_driver()
{
	...
	{
         ALOGE("insmod %s ko succ!", wifi_driver_name);
	}
...
int wifi_unload_driver()
{
    ...
    if(strncmp(wifi_vendor_name, "southsv", strlen("southsv")) == 0) {
        ifc_init();
        ifc_down("wlan0");
        ifc_down("p2p0");
        ifc_close();
...
int wifi_start_supplicant(int p2p_supported)
{
    ...
    if (p2p_supported) {
        ...
        if(strncmp(get_wifi_vendor_name(), "southsv", strlen("southsv")) == 0) {
            ifc_init();
            ifc_up("wlan0");
            ifc_up("p2p0");
            ifc_close();
    ...
    while (count-- > 0) {
        ...
        if (strncmp(get_wifi_vendor_name(), "xradio", strlen("xradio")) != 0) {
            if (pi != NULL) {
                /*
...
int wifi_change_fw_path(const char *fwpath)
{
	...
	if(strncmp(get_wifi_vendor_name(), "realtek", strlen("realtek")) == 0
	        || strncmp(get_wifi_vendor_name(), "southsv", strlen("southsv")) == 0
	        || strncmp(get_wifi_vendor_name(), "xradio", strlen("xradio")) == 0) {
		return 0;
