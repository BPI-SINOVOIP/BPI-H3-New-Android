...
struct {
    ...
    { "media.boost.pref", AID_MEDIA,     0 },
    { "sys.boost.pref",   AID_SYSTEM,    0 },
    { "epg.",             AID_SYSTEM,   0 },
    { NULL, 0, 0 }
};
...
static int enable_adaptive_memory(void)
{
    ...
    unsigned int dram_size = get_dram_size();
    FILE *proc_sys_vm = NULL;
    char *param_set = NULL;
    int ret = 0;
	...
	property_set("dalvik.vm.heaptargetutilization", "0.75");
        ...
        property_set("dalvik.vm.heapgrowthlimit", "72m");
	property_set("dalvik.vm.heaptargetutilization", "0.75");
