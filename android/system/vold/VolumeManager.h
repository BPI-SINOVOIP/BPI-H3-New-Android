...
typedef android::List<char*> UsbDevPathCollection;
...
private:
    ...
    static const int MAX_VOLUMES = 99;
    bool volumeBitmap[MAX_VOLUMES];

    unsigned int volumeLastCreatedBit;
    UsbDevPathCollection *mUsbDevPathCollection;
public:
    ...
    int addVolume(unsigned int devId, const char* devPath);
    ...
    void updateUsbVolumes();
    void recycleUsbVolumes();
    ...
    void addUsbDevPath(char *path);
    bool isUsbDevPath(const char *path);
    void cleanUsbDevPath();
    void dumpVolumes();
...
private:
    ...
    void removeVolume(unsigned int devId);
    Volume* makeNewVolume(unsigned int devId, const char* devPath);
};
