...
public:
    ...
    static const int DISABLE     =2;
    static const int RECYCLE     =3;
    ...
    static const char *USB_STORAGE_PATH;
...
public:
    ...
    Volume(VolumeManager *vm, int labelIndex,unsigned int devId);
    virtual ~Volume();
    ...
    unsigned int getDevId() {return mDevId;}
    int getLabelIndex() {return mLabelIndex;}
    int getEnable();
