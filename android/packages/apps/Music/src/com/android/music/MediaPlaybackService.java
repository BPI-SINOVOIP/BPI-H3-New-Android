...
public class MediaPlaybackService extends Service {
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
						...
						if(audio_path.startsWith(storagePath)){
							saveQueue(true);
                        	mQueueIsSaveable = false;
                        	closeExternalStorageFiles(storagePath);
						}
    ...
    private class MultiPlayer {
        ...
        public void start() {
			...
			Cursor actualaudiocursor = getContentResolver().query(Uri.parse(mFileToPlay), proj, null, null, null);
			...
			audio_path = actualaudiocursor.getString(actual_audio_column_index);
