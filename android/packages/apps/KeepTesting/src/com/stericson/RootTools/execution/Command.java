...
public abstract class Command {
    ...
    int exitCode = -1;
    int id = 0;
    long timeout = RootTools.default_Command_Timeout;
     ...
     * @param command the command, or commands, to be executed.
     */
    public Command(int id, long timeout, String... command) {
        this.command = command;
        this.id = id;
     ...
     * @param context     needed to execute java command.
     */
    public Command(int id, long timeout, boolean javaCommand, Context context, String... command) {
