...
public class CaseHdmi extends IBaseCase {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case WHAT_CHECK_HDMI_STATUS:
				...
				if (isConn) {
					...
					mHandler.sendEmptyMessageDelayed(WHAT_CHECK_HDMI_STATUS,
							1000);
				}
	...
	public CaseHdmi(Context context) {
		...
		mMinSoundStatusTV = (TextView) mMinView
				.findViewById(R.id.case_hdmi_sound_status_text);
	}
	...
	public void onStopCase() {
		hm.stopMusic();
		mMinSoundStatusTV
				.setText(getCaseResult() ? R.string.case_hdmi_sound_status_success_text
