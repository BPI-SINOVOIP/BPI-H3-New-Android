                ...
                if(action.equals("add")){
                    ...
                    try{
                        if(audioType.equalsIgnoreCase(uAudioInType)){
                            ...
                            mAudioManager.getAudioDevices(AudioManager.AUDIO_INPUT_TYPE); //update the audio hal
                            updateState(sndNameMap, AUDIO_INPUT_TYPE, PLUG_OUT);
                        }else if(audioType.equalsIgnoreCase(uAudioOutType)){
                            SystemClock.sleep(5);
                            sndNameMap = findNameMap(devName, false, true);
                            mAudioManager.getAudioDevices(AudioManager.AUDIO_OUTPUT_TYPE); //update the audio hal
