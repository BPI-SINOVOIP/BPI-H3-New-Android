...
class AlarmManagerService extends IAlarmManager.Stub {
    ...
    public void set(int type, long triggerAtTime, long windowLength, long interval,
        ...
        if(type == RTC_WAKEUP || type == ELAPSED_REALTIME_WAKEUP ||
            type == RTC_SUSPEND_WAKEUP || type == RTC_SHUTDOWN_WAKEUP) {

            Slog.d("alarmDebug", "setAlarm, packagename = " + operation.getTargetPackage() + " type = " + type +
                " after " + (triggerElapsed - nowElapsed)/1000 + " ,interval = " + interval/1000);
        }
    ...
    private void rescheduleKernelAlarmsLocked() {
        ...
        if (mAlarmBatches.size() > 0) {
            ...
            if (firstWakeup != null && mNextWakeup != firstWakeup.start) {
                ...
                Slog.d("alarmDebug", "setKernel, wakeup at " + firstWakeup.start/1000);
            }
