...
public class NsdService extends INsdManager.Stub {
    ...
    private int getUniqueId() {
        if (++mUniqueId == INVALID_ID) ++mUniqueId;
        //fix cts failed: android.net.wifi.cts.NsdManagerTest#testAndroidTestCaseSetupProperly;
        //when mUniqueId > 127,clientInfo.mClientIds.indexOfValue(128) = -1;
        if (mUniqueId > 127)
             mUniqueId = 2;
        Slog.d(TAG,"mUniqueId = " + mUniqueId);
        return mUniqueId;
    }
