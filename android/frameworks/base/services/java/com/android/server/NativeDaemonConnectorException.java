...
import com.android.server.MountService.VoldResponseCode;
...
public class NativeDaemonConnectorException extends Exception {
    ...
    public int getCode() {
        ...
        // if mEvent is not initial, return OpFailedStorageBusy default.
        if(mEvent==null){
            return VoldResponseCode.OpFailedStorageBusy;
        } else {
