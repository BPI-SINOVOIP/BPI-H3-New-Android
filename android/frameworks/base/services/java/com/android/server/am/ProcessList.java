...
final class ProcessList {
    ...
    private void updateOomLevels(int displayWidth, int displayHeight, boolean write) {
        ...
        int reserve = displayWidth * displayHeight * 16 * 3 / 1024;
        int reserve_adj = Resources.getSystem().getInteger(com.android.internal.R.integer.config_extraFreeKbytesAdjust);
        int reserve_abs = Resources.getSystem().getInteger(com.android.internal.R.integer.config_extraFreeKbytesAbsolute);
	Slog.e("XXXXXX", "reserve=" + minfree_adj + " reserve_adj=" + reserve_adj + " reserve_abs=" + reserve_abs);
        if (reserve_abs >= 0) {
            reserve = reserve_abs * 4;
        }
        ...
        if( !SystemProperties.getBoolean("ro.config.low_ram", false) ) {
             memString.append("14336,16384,20480,24576,28672,32768");//*4 = mOomMinFree for 1GB
             mOomMinFree[0] = 57344;
             mOomMinFree[1] = 65536;
             mOomMinFree[2] = 81920;
             mOomMinFree[3] = 98304;
             mOomMinFree[4] = 114688;
             mOomMinFree[5] = 131072;
        } else {
             memString.append("3072,4096,6144,10240,12288,14336");//*4 = mOomMinFree for 512M
             mOomMinFree[0] = 12288;
             mOomMinFree[1] = 16384;
             mOomMinFree[2] = 24576;
             mOomMinFree[3] = 40960;
