...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
			...
			loadIntegerSetting(stmt, Settings.System.DISPLAY2_ENHANCE_MODE,
                    R.integer.def_display2_enhance_mode);
            ...
            loadIntegerSetting(stmt, Settings.System.DISPLAY_AREA_H_PERCENT,
                    R.integer.def_display_area_h_percent);
            loadIntegerSetting(stmt, Settings.System.DISPLAY_AREA_V_PERCENT,
                    R.integer.def_display_area_v_percent);
            /* add by Gary. end   -----------------------------------}} */
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadStringSetting(stmt, Settings.Global.ETHERNET_IFACENAME,
                    R.string.def_ethernet_ifacename);

            loadBooleanSetting(stmt, Settings.Global.ETHERNET_ON,
                    R.bool.def_ethernet_on);

            loadStringSetting(stmt, Settings.Global.ETHERNET_MODE,
                    R.string.def_ethernet_mode);

            loadIntegerSetting(stmt, Settings.Global.ETHERNET_USE_IPOE,
                    R.bool.def_ethernet_use_ipoe);
            loadIntegerSetting(stmt, Settings.Global.ETHERNET_USE_PPPOE,
                    R.bool.def_ethernet_use_pppoe);
			...
			// star add global for overlay window_animation_scale and window_transition_scale
