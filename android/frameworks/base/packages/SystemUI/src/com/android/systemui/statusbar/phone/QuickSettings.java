...
class QuickSettings {
    ...
    private void addTemporaryTiles(final ViewGroup parent, final LayoutInflater inflater) {
        ...
        // Ethernet
        final QuickSettingsBasicTile ethernetTile
                = new QuickSettingsBasicTile(mContext);
        ethernetTile.setImageResource(R.drawable.ic_qs_ethernet_established);
        ethernetTile.setTextResource(R.string.quick_settings_ethernet_no_connection_label);
        ...
        mModel.addEthernetTile(ethernetTile, new QuickSettingsModel.RefreshCallback() {
            @Override
            public void refreshView(QuickSettingsTileView view, State state) {
                ethernetTile.setImageResource(state.iconId);
                ethernetTile.setText(state.label);
            }
        });
