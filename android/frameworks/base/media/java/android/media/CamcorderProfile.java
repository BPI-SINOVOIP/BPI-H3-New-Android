...
public class CamcorderProfile
{
    ...
    /**
     * Quality level corresponding to the 4K (3840x2160) resolution.
     */
    public static final int QUALITY_4K_3840_2160 = 8;

    // Start and end of quality list
    private static final int QUALITY_LIST_START = QUALITY_LOW;
    private static final int QUALITY_LIST_END = QUALITY_4K_3840_2160;
    ...
    /**
     * Time lapse quality level corresponding to the 4K (3840 x 2160) resolution.
     */
    public static final int QUALITY_TIME_LAPSE_4K_3840_2160 = 1008;

    // Start and end of timelapse quality list
    private static final int QUALITY_TIME_LAPSE_LIST_START = QUALITY_TIME_LAPSE_LOW;
    private static final int QUALITY_TIME_LAPSE_LIST_END = QUALITY_TIME_LAPSE_4K_3840_2160;
