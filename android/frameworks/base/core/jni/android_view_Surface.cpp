...
static jint nativeGetDisplayParameter(JNIEnv* env, jclass clazz,
        jint displayId, jint cmd, jint para0, jint para1) {
    return SurfaceComposerClient::getDisplayParameter(displayId, cmd, para0, para1);
}
...
static JNINativeMethod gSurfaceMethods[] = {
    ...
    {"nativeGetDisplayParameter", "(IIII)I",
            (void*)nativeGetDisplayParameter },
