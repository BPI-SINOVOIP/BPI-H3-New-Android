...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_SECURE.add(Secure.HOME_PAGE);
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            DISPLAY_AREA_RATIO,
            DISPLAY_AREA_H_PERCENT,
            DISPLAY_AREA_V_PERCENT,
            /* add by Gary. end   -----------------------------------}} */
    ...
    public static final class Secure extends NameValueTable {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_USE_IPOE);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_USE_PPPOE);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_ON);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_MODE);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_IPADDR);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_NETMASK);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_DNS1);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_DNS2);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_GATEWAY);
            MOVED_TO_GLOBAL.add(Settings.Global.ETHERNET_IFACENAME);
