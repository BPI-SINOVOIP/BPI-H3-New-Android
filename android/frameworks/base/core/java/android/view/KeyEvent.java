...
public class KeyEvent extends InputEvent implements Parcelable {
	...
	// add for karaok by linjunqian
        names.append(KEYCODE_MIC_VOLUME_UP, "KEYCODE_MIC_VOLUME_UP");
        names.append(KEYCODE_MIC_VOLUME_DOWN, "KEYCODE_MIC_VOLUME_DOWN");
        names.append(KEYCODE_KOUT_VOLUME_UP, "KEYCODE_KOUT_VOLUME_UP");
        names.append(KEYCODE_KOUT_VOLUME_DOWN, "KEYCODE_KOUT_VOLUME_DOWN");
        /* add by Gary. start {{----------------------------------- */
        /* 2011-10-27 */
        /* add some new keys for TVD */
