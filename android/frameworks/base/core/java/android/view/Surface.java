...
public class Surface implements Parcelable {
    ...
    private static native int nativeGetDisplayParameter(int displayId, int cmd, int para0, int para1);
    private static native int nativeSetDisplayParameter(int displayId, int cmd, int para0,
            int para1, int para2);
    ...
    /** @hide */
    public static int getDisplayParameter(int displayId, int cmd, int para0, int para1) {
        return nativeGetDisplayParameter(displayId, cmd, para0, para1);
    }
