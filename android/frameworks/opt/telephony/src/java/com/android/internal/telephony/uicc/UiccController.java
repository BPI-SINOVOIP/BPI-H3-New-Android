...
public class UiccController extends Handler {
    ...
    private synchronized void onGetIccCardStatusDone(AsyncResult ar) {
        ...
        Rlog.i(LOG_TAG, "mUiccCard="+mUiccCard);
        ...
        if (mUiccCard == null) {
            ...
            /*
             * In android4.4, UiccCard will not free until pad power off.
            ...
            if(SystemProperties.get("ro.sw.embeded.telephony").equals("true")) {
                ...
                Rlog.i(LOG_TAG, "Update already existing card");
                mUiccCard.update(mContext, mCi , status);
            }else{
                Rlog.i(LOG_TAG, "external dongle platform, create new card");
                mUiccCard.dispose();
                mUiccCard = new UiccCard(mContext, mCi, status);
            }
        }
