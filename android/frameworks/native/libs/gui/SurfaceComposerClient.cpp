...
int SurfaceComposerClient::getDisplayParameter(
        int displayId, int cmd, int para0, int para1)
{
    return ComposerService::getComposerService()->getDisplayParameter(displayId,
            cmd, para0, para1);
}
