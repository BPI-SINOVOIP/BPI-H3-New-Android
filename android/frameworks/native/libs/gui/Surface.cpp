...
int Surface::dequeueBuffer(android_native_buffer_t** buffer, int* fenceFd) {
    ...
    ALOGE_IF(fence == NULL, "Surface::dequeueBuffer: received null Fence! buf=%d, result=%d", buf, result);
...
int Surface::dispatchSetParameter(va_list args){
    ...
    int para0, para1, para2, para3, para4;
    switch(cmd){
    case DISPLAY_CMD_SETSCREENRADIO:
        para0 = va_arg(args, int);
        composer->setDisplayParameter(0, DISPLAY_CMD_SETSCREENRADIO,para0, 0, 0);
        break;
    case DISPLAY_CMD_SETVIDEOENABLE:
        para0 = va_arg(args, int);
        composer->setDisplayParameter(0, DISPLAY_CMD_SETVIDEOENABLE, para0, 0, 0);
        break;
    case DISPLAY_CMD_SETVIDEOPOSITION:
        para0 = va_arg(args, int); //x
        para1 = va_arg(args, int); //y
        composer->setDisplayParameter(0, DISPLAY_CMD_SETVIDEOPOSITION, para0, para1, 0);
        break;
    case DISPLAY_CMD_SETVIDEOSIZE:
        para0 = va_arg(args, int); //width
        para1 = va_arg(args, int); //height
        composer->setDisplayParameter(0, DISPLAY_CMD_SETVIDEOSIZE, para0, para1, 0);
        break;
    }
    return NO_ERROR;
}
...
int Surface::dispatchGetParameter(va_list args){
    ...
    case DISPLAY_CMD_GETDISPFPS:
        return composer->getDisplayParameter(0, DISPLAY_CMD_GETDISPFPS, 0, 0);
    case NATIVE_WINDOW_CMD_GET_SURFACE_TEXTURE_TYPE:
