...
public:
    ...
    virtual int getDisplayParameter(int displayId, int cmd, int para0,
        int para1)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISurfaceComposer::getInterfaceDescriptor());
        ...
        remote()->transact(BnSurfaceComposer::GET_DISPLAY_PARAMETER, data, &reply);
        return reply.readInt32();
    }
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        ...
        case GET_DISPLAY_PARAMETER: {
            ...
            int result = getDisplayParameter(displayId, cmd, para0, para1);
            reply->writeInt32(result);
            return NO_ERROR;
        } 
