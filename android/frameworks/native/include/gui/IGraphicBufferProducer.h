...
public:
    ...
    struct QueueBufferInput : public Flattenable<QueueBufferInput> {
        ...
        inline QueueBufferInput(int64_t timestamp, bool isAutoTimestamp,
                ...
                const sp<Fence>& fence, uint32_t videoAddr0 = 0, uint32_t videoAddr1 = 0,
                uint32_t videoAddr2 = 0, uint32_t videoAddr3 = 0, uint32_t videoAddr4 = 0,
                uint32_t videoAddr5 = 0,  uint32_t videoFormat = 0,
                uint32_t interlace = 0, uint32_t topFieldFirst = 0)
        : timestamp(timestamp), isAutoTimestamp(isAutoTimestamp), crop(crop),
          scalingMode(scalingMode), transform(transform), async(async),
          fence(fence), videoAddr0(videoAddr0), videoAddr1(videoAddr1),
           videoAddr2(videoAddr2), videoAddr3(videoAddr3), videoAddr4(videoAddr4),
            videoAddr5(videoAddr5), videoFormat(videoFormat),
            interlace(interlace), topFieldFirst(topFieldFirst) { }
        ...
        inline void deflate(int64_t* outTimestamp, bool* outIsAutoTimestamp,
                Rect* outCrop, int* outScalingMode, uint32_t* outTransform,
                bool* outAsync, sp<Fence>* outFence, uint32_t* outVideoAddr0,
                uint32_t* outVideoAddr1, uint32_t* outVideoAddr2,
                uint32_t* outVideoAddr3, uint32_t* outVideoAddr4,
                uint32_t* outVideoAddr5, uint32_t* outVideoFormat,
                uint32_t* outInterlace, uint32_t* outTopFieldFirst) const {
            *outTimestamp = timestamp;
            *outIsAutoTimestamp = bool(isAutoTimestamp);
            *outCrop = crop;
            *outScalingMode = scalingMode;
            ...
            *outAsync = bool(async);
            *outFence = fence;
            *outVideoAddr0 = videoAddr0;
            *outVideoAddr1 = videoAddr1;
            *outVideoAddr2 = videoAddr2;
            *outVideoAddr3 = videoAddr3;
            *outVideoAddr4 = videoAddr4;
            *outVideoAddr5 = videoAddr5;
            *outVideoFormat = videoFormat;
			*outInterlace = interlace;
			*outTopFieldFirst = topFieldFirst;
        }
    ...
    virtual int getVideoOutputType() = 0;
};
