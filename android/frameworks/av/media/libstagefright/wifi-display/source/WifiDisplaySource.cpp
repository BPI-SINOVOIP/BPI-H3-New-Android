...
void WifiDisplaySource::onMessageReceived(const sp<AMessage> &msg) {
    ...
    ALOGD("magic test. ==> onMessageReceived enter. message: %d", msg->what());
    //0-Start, 1-RTSPNotify, 2-Stop, 3-Pause, 4-Resume, 5-ReapDeadClients, 6-PlaybackSessionNotify,
    //7-KeepAlive, 8-HDCPNotify, 9-FinishStop2, 10-TeardownTriggerTimedOut,
...
status_t WifiDisplaySource::sendM4(int32_t sessionID) {
    ...
    if (mSinkSupportsVideo) {
        ...
        body.append(chosenVideoFormat.getFormatSpec(false /* forM4Message */)); //default: true
        body.append("\r\n");
    }
...
status_t WifiDisplaySource::onReceiveM16Response(
    ...
    ALOGD("magic test. onReceiveM16Response enter.");
    CHECK_EQ(sessionID, mClientSessionID);
    ...
    ALOGD("magic test. onReceiveM16Response end.");
...
void WifiDisplaySource::scheduleKeepAlive(int32_t sessionID) {
    ...
    ALOGD("magic test. scheduleKeepAlive msg->post keep alive");
...
status_t WifiDisplaySource::onReceiveClientData(const sp<AMessage> &msg) {
    ...
    ALOGD("magic test. onReceiveClientData method: %s.", method.c_str());
...
status_t WifiDisplaySource::onOptionsRequest(
    ...
    ALOGD("magic test. onOptionsRequest return %d, send message:\n%s", err, response.c_str());
...
status_t WifiDisplaySource::onPlayRequest(
    ...
    ALOGD("magic test. onPlayRequest enter.");
...
status_t WifiDisplaySource::onSetParameterRequest(
    ...
    ALOGD("magic test. onSetParameterRequest return: %d. message:\n%s", err, response.c_str());
...
void WifiDisplaySource::sendErrorResponse(
    ...
    ALOGD("magic test. sendErrorResponse message:\n%s", response.c_str());
