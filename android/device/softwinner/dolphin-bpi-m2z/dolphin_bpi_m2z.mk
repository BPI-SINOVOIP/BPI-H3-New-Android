...
DEVICE_PACKAGE_OVERLAYS := \
    device/softwinner/dolphin-bpi-m2z/overlay \
    $(DEVICE_PACKAGE_OVERLAYS)
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/dolphin-bpi-m2z/fstab.sun8i:root/fstab.sun8i \
    device/softwinner/dolphin-bpi-m2z/init.rc:root/init.rc \
    device/softwinner/dolphin-bpi-m2z/verity/rsa_key/verity_key:root/verity_key \
    device/softwinner/dolphin-bpi-m2z/init.recovery.sun8i.rc:root/init.recovery.sun8i.rc \
    device/softwinner/dolphin-bpi-m2z/ueventd.sun8i.rc:root/ueventd.sun8i.rc \
...
PRODUCT_COPY_FILES += \
    device/softwinner/dolphin-bpi-m2z/configs/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml
...
PRODUCT_COPY_FILES += \
    device/softwinner/dolphin-bpi-m2z/initlogo.rle:root/initlogo.rle \
    device/softwinner/dolphin-bpi-m2z/needfix.rle:root/needfix.rle \
    device/softwinner/dolphin-bpi-m2z/media/bootanimation.zip:system/media/bootanimation.zip

#BPI-M2_Plus
PRODUCT_COPY_FILES += \
    device/softwinner/dolphin-bpi-m2z/rild/su:system/xbin/su
