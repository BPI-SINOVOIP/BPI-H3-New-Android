ifneq (,$(findstring $(TARGET_DEVICE),dolphin-fvd-p1-secure))
...
LOCAL_MODULE := librecovery_ui_dolphin_fvd_p1_secure
...
LOCAL_MODULE := librecovery_updater_dolphin_fvd_p1_secure
