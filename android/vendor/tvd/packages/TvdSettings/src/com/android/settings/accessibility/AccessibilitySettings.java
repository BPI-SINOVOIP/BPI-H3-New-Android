...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    public void onCreate(Bundle icicle) {
		...
		//getPreferenceScreen().removePreference(mDisplayMagnificationPreferenceScreen);
		//getPreferenceScreen().removePreference(findPreference(DISPLAY_MAGNIFICATION_PREFERENCE_SCREEN));
    }
