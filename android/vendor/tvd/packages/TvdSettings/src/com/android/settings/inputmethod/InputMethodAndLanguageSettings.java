...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    private void adjustFocusIfNeeded() {
        if (_mListView != null && _mListView.hasFocus() && _mListView.getChildCount()>0) {
            _mListView.setSelection(0);
            _mListView.requestFocus(0);
        }
    }
