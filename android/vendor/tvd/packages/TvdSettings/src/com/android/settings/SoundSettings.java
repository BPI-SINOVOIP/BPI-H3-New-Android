...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       /* add by chenjd 2014.02.14, start ---{{{
        * add preference for Audio Output Selection
        */
    ...
    public void onResume() {
        ...
        mAudioSelector.registerAudioReceiver();
    }
    ...
    public void onPause() {
        ...
        mAudioSelector.unregisterAudioReceiver();
