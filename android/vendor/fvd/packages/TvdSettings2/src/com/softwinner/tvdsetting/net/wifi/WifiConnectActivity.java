...
//		mCheckBox = (CheckBox)this.findViewById(R.id.wifi_showpasswd);
...
//		    	Log.e("PASSWORD", "come =" +config.preSharedKey);
//		        mPassword.setText(config.preSharedKey);
//		    }
		    mPassword.setOnFocusChangeListener(this);
		    mPassword.setOnEditorActionListener(this);
//		    ExtImageButton mSubmit = (ExtImageButton)findViewById(R.id.static_submit);
...
//		if(buttonView.getId()==R.id.wifi_showpasswd){
//			if(isChecked){
//				mPassword.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
//			}else{
