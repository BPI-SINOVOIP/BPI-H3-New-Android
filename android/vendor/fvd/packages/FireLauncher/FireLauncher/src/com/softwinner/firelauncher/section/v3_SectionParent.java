...
public abstract class v3_SectionParent extends HorizontalScrollView implements View.OnFocusChangeListener, 
	...
	public onLeftInterface mOnLeft = null;
	...
	/**
	 * focus will leaving this section on left,left dialog will show
	 * */
...
//				Log.w(TAG, "X "+mScroller.getCurrX() + ", dx "+ dx);
	...
	public void setOnLeftListioner(onLeftInterface l){
		mOnLeft = l;
	}
