...
public class launcherViewPager extends ViewPager implements v3_SectionParent.PageChangeInterface{
	...
	public void setUp(Activity activity){
        ...
        for(int i = 0;i<lists.size();i++){
        	...
        	if(activity instanceof v3_SectionParent.onLeftInterface ){
        		Log.d(TAG, "setOnLeftListioner");
        		lists.get(i).setOnLeftListioner((v3_SectionParent.onLeftInterface)activity);
        	}
