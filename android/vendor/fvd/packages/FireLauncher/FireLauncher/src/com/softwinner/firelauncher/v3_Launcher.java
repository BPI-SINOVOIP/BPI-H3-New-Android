...
public class v3_Launcher extends Activity implements onJsonLoaderFinishListener,v3_SectionParent.onTopInterface,
                v3_SectionParent.onLeftInterface {
    ...
    public static final int FLASH_NETWORK_STATE = 666669;
	...
	private final long NETWORK_STATE_FLASH_INTERVAL = 5*1000;
	...
	Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case FLASH_NETWORK_STATE:
				// 没有连接到wifi，更新UI
				NetworkConnect();
                sendEmptyMessageDelayed(FLASH_NETWORK_STATE, NETWORK_STATE_FLASH_INTERVAL);
				break;
	...
	protected void onResume() {
		...
		viewPager.onResume();
		super.onResume();
        mHandler.sendEmptyMessage(FLASH_NETWORK_STATE);
